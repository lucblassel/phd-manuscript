...
-   Minimap2 [@liMinimap2PairwiseAlignment2018] minimizer hash table
...
HMM method similar performance to clustal-w [@eddyMultipleAlignmentUsing], HHMer [@finnHMMERWebServer2011] and COVID-align COVID-align [@lemoineCOVIDAlignAccurateOnline2020]
...
-   Simulated annealing to speed up DP [@kimMultipleSequenceAlignment1994; @ishikawaMultipleSequenceAlignment1993]

-   Genetic algorithm, review [@chowdhuryReviewMultipleSequence2017]

    -   SAGA [@notredameSAGASequenceAlignment1996]
...
## The specifities of read-mapping {#the-specifities-of-read-mapping}
...
-   Benchmarking is of interest of field [@brindaRNFGeneralFramework2016]
