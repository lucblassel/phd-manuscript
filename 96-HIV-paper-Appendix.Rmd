...
African dataset**  
(i.e. the prevalence of the new mutation in sequences
...
```{r}
s2Caption <- "**Closeup structural view of the entrance of the NNIBP of HIV-1 RT**  
The p66 subunit is colored in dark gray, the p51 subunit in light gray. The
...
```{r}
s3Caption <- "**Closeup structural view of the active site of HIV-1 RT.**  
The p66 subunit is colored in dark gray, the p51 subunit in light gray. The
...
dt <- read_csv("tables/HIV-DRMs/Table3.long.csv")
...
labels <- data.frame(
  ...
  measure = c("mutation","T/N","W/W","min","UK","Africa","count","RR(new,treatment)","RR(new,with RAM)","count","RR(new,treatment)","RR(new,with RAM)","p‑value","B62","Dayhoff category","net charge","polarity","hydrophobicity","molecular weight"),
