...
-   Transformers / NN-based language models:
    ...
    -   protein language models have been developed from this with the same idea.
        ...
        -   They have interesting properties [@beplerLearningProteinLanguage2021]:
            ...
            -   Intuitively learn structure of proteins [@raoTransformerProteinLanguage2020; @rivesBiologicalStructureFunction2019; @bhattacharyaSingleLayersAttention2020]

            -   Protein function [@huExploringEvolutionbasedFree2022]

            -   Learn mutational effects [@meierLanguageModelsEnable2021]

            -   Evolutionary characteristics [@hieEvolutionaryVelocityProtein2022]

            -   Even used to generate relevant protein sequences [@madaniProGenLanguageModeling2020]

            -   Even when trained on DNA, they learn variant effects [@benegasDNALanguageModels2022]
    ...
    -   MSA Transformer [@raoMSATransformer2021] that extends attention to include aligned residues from an input MSA as well.
        ...
        -   Transformer used subreads aligned to CCS + sequencer info to polish HiFi reads [@baidDeepConsensusImprovesAccuracy2022]

    -   EvoFormer from Alphafold2 [@jumperHighlyAccurateProtein2021] also takes MSAs as inputs to predict protein contacts (and is trained end-to-end)
