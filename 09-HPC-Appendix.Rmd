...
## MSR performance comparison {#tab:mapperComparison}

Comparing performance of MSRs on the whole human genome, whole
*Drosophila melanogaster* genome, repeated regions of the whole human
genome and synthetic centromeric sequence. Results using
`minimap2`[@liMinimap2PairwiseAlignment2018] and
`winnowmap2`[@jainWeightedMinimizerSampling2020]. The number of
...
\msr{E}                             & 0.946          & \footnotesize{\;$-$1\%}           & \textbf{0.00}     & \textbf{\footnotesize{\;$-$100\%}} & 0.954          & \footnotesize{\;$-$1\%}           & \textbf{0.00}     & \textbf{\footnotesize{\;$-$100\%}} & \textbf{0.998} & \textbf{\footnotesize{\;$+$0\%}} & 1.53e-02          & \footnotesize{\;$+$ 3\%}          \\
...
## Origin of incorrectly mapped reads of high mapping quality on whole human genome. {#fig:error-hists}
...
## Analyzing read origin on whole human genome {#appendix:all-reads-hist}
...
```{r, eval=knitr::is_html_output()}
knitr::include_graphics("./figures/HPC-MSRs/drosophila.tweaked.png")
```
\begin{center}
...
mapped to a whole *Drosophila melanogaster* genome. MSRs E, F and P are
