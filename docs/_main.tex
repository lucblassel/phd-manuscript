...
\begin{figure} 
  ...
  This figure was adapted from the PDB 101 molecule of the month Integrase entry by David S. Goodsell and the RCSB PDB (\href{https://pdb101.rcsb.org/motm/135}{pdb101.rcsb.org/motm/135}) with a CC By 4.0 license.}       
  \label{fig:inStruct} 
\end{figure}
