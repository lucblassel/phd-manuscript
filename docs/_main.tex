...
\fi
\usepackage[style=authoryear,backref=true,refsegment=chapter,defernumbers=true,sorting=nyt,maxnames=3,maxbibnames=3,minnames=2,uniquelist=false,backend=biber]{biblatex}
...
\item
  In Hybrid methods, shorter more accurate reads are used to correct long-read errors, it has been used in software like proovread \autocite{hacklProovreadLargescaleHighaccuracy2014}, Jabba \autocite{miclotteJabbaHybridError2016} or LoRDEC \autocite{salmelaLoRDECAccurateEfficient2014}
\item
...
This is very similar to another well known problem in computer science: the string-edit problem (\textbf{REFS?})
...
\hypertarget{how-to-align}{%
\subsection{How to align ?}\label{how-to-align}}
...
into smaller sub-problems and solving each one optimally and separately \autocite{bradleyAppliedMathematicalProgramming1977}, it is widely used when we wish to have a precise alignment between 2 sequences.
...
\item
  Used in software: \ldots{}
\end{itemize}

\hypertarget{substitution-models}{%
\subsection{Substitution models}\label{substitution-models}}

mismatch depends on models, BLOSUM, PAML, \ldots{}

\hypertarget{dealing-with-gaps}{%
\subsubsection{Dealing with gaps}\label{dealing-with-gaps}}
...
\hypertarget{how-do-we-speed-up-alignment}{%
\section{How do we speed up alignment ?}\label{how-do-we-speed-up-alignment}}

\hypertarget{heuristic-algorithms}{%
\subsection{Heuristic algorithms}\label{heuristic-algorithms}}
...
\hypertarget{indexes-heuristics}{%
\subsection{Indexes + heuristics}\label{indexes-heuristics}}

Pre-computing indexes -\textgreater{} when we know we will have lots of queries:
...
\item
  ...
  \item
    low homology / sequencing errors\ldots{}
  \end{itemize}
\item
  specific heuristics like minimizers / FM-index help \emph{(Needed here since I introduce it earlier ? )}
\end{itemize}
