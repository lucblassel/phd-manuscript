...
\item
  ...
  \item
    ...
    \item
      p7: nucleocapsid
    \item
      p6: promotes budding / virion release \autocite{gottlingerEffectMutationsAffecting1991,huangP6GagRequiredParticle1995}
    \end{itemize}
  \item
    pol polyprotein: -\textgreater{} functional proteins
  ...
  \item
    ...
    \begin{itemize}
    \item
      gp 120: responsible for biding to CD4 cells \autocite{bourHumanImmunodeficiencyVirus1995}
    \item
