...
% Number footnotes with letters (not to confuse with Nature style citations)
...
\fi
\usepackage[style=authoryear,backref=true,refsegment=chapter,defernumbers=true,sorting=none,uniquelist=false,style=numeric-comp,maxcitenames=2,maxnames = 5,firstinits=true,uniquename=init,url=false,isbn=false,eprint=false,texencoding=utf8,bibencoding=utf8,autocite=superscript,backend=biber]{biblatex}
...
\addbibresource{./references/Learning-from-alignments.bib}
\addbibresource{./references/Learning-alignments.bib}
