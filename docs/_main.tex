...
\hypertarget{publications-produced}{%
\section*{Publications produced}\label{publications-produced}}
\addcontentsline{toc}{section}{Publications produced}
...
\item
  ...
  \href{https://google.com}{DOI goes here} \emph{(Included in Chapter \ref{HPC-paper})}
\item
...
\item
  ...
  \href{https://doi.org/10.1371/journal.pcbi.1008873}{10.1371/journal.pcbi.1008873}. \emph{(Included in Chapter \ref{HIV-paper})}
\item
...
\item
  HMMs: \textbf{\emph{(I Need to find out if they actually are faster for pairwise, and how fast)}}
...
\item
  Minimap2 \autocite{liMinimap2PairwiseAlignment2018} minimizer hash table
\item
...
HMM method similar performance to clustal-w \autocite{eddyMultipleAlignmentUsing}, HHMer \autocite{finnHMMERWebServer2011} and COVID-align COVID-align \autocite{lemoineCOVIDAlignAccurateOnline2020}
...
\begin{itemize}
\item
  Simulated annealing to speed up DP \autocite{kimMultipleSequenceAlignment1994,ishikawaMultipleSequenceAlignment1993}
\item
  Genetic algorithm, review \autocite{chowdhuryReviewMultipleSequence2017}

  \begin{itemize}
  \tightlist
  \item
    SAGA \autocite{notredameSAGASequenceAlignment1996}
  \end{itemize}
\item
...
\hypertarget{the-specifities-of-read-mapping}{%
\section{The specifities of read-mapping}\label{the-specifities-of-read-mapping}}
...
\item
  Mapping is hard (c.f. \ref{the-specifities-of-read-mapping})
\item
