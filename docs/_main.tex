...
\fi
\usepackage[style=authoryear,backref=true,refsegment=chapter,defernumbers=true,sorting=nyt]{biblatex}
...
There are several sources of error that can alter the genetic information:
...
\item
  \textbf{RNA transcription:} when DNA is transcribed into RNA
\item
  \textbf{Other mutagenic events:} UV rays, other stuff\ldots{}
\end{itemize}
...
\item
  ...
  \autocite{nurkCompleteSequenceHuman2021}. We used the 1.1 assembly release (Genbank
  Assembly ID
...
\hypertarget{predictind-an-alignment}{%
\subsection{predictind an alignment}\label{predictind-an-alignment}}
