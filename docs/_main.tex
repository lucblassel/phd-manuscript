...
\hypertarget{goal-of-this-thesis}{%
\section*{Goal of this Thesis}\label{goal-of-this-thesis}}
\addcontentsline{toc}{section}{Goal of this Thesis}
...
\hypertarget{indexed-blast}{%
\subsection{Indexed \ldots{} BLAST,\ldots{}}\label{indexed-blast}}

short explanation of BLAST or suffix-arrays, \ldots{}

\hypertarget{seeded-minimap2}{%
\subsection{Seeded, minimap2, \ldots{}}\label{seeded-minimap2}}

How minimap works, rough idea

\hypertarget{msa}{%
\section{MSA}\label{msa}}
...
\hypertarget{hmms-index-alignment-pairwise}{%
\subsubsection{HMMs / index alignment / pairwise}\label{hmms-index-alignment-pairwise}}

Example of COVID where homology is high so we can get away with using HMMS / pairwise to root sequence. \emph{(point to appendinx with covid align ?)}
...
Resistant or not, compartiments in the cell, \ldots{}
...
\hypertarget{presentation-of-hiv}{%
\subsection{Presentation of HIV}\label{presentation-of-hiv}}
...
\hypertarget{transformers-and-deep-embedding}{%
\subsection{Transformers and deep embedding}\label{transformers-and-deep-embedding}}
