...
For most of my PhD, except for a few months in early 2020\ldots, I spent my time on the 6th floor of the Omics building of the Institut Pasteur, in the \emph{Evolutionary Bioinformatics} lab. Thank you to all my office mates for making my time on the 6th floor so pleasant. Thank you Anna, Fred and Jakub for all the discussions and coffee breaks. A special thanks to my good-\textbf{\emph{colleague}} Marie, who has~ ingrained in me the response of looking up and to the right whenever I hear an office chair move. Thank you also to the 6th floor adoptees: Jerome, Andrew, and Arthur, the earliest of them. I would also like to thank my labmates from the \emph{Sequence Bioinformatics} lab: Camilla, Francesco, Yoann, Riccardo, Luca and Téo.

Of course, as studious as I might wish to be, I did spend 4 years at the office. I would therefore like to thank all my friends that have made them enjoyable. Grimault, Nathalie, Théo and Élise for the German escapades and the \emph{(first of many I hope)} canyoning outings. Thank you as well to Eva M., Max, and Flore for being there throughout the years, and thank you to Eva C., Celia and all the other Spanish-sectionites for making me tolerate reggaeton. It has been a while since the Balzac days, but I am very glad we all still hang out! Dylan and Joshua, I started this adventure with you as roommates and enjoyed it very much, so thank you as well! Finally, thank you to Marie, Anna and Jean for many, many \emph{(many!)} celebrations! Without all of you, my time as a PhD student would definitely have been less fun.
