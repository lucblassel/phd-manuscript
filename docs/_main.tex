...
\emph{Homopolymers} consist of a stretch of repeated nucleotides (i.e.~\(\geq 2\)) occurring at some point in the genome. For example the sequence AAAA is a length 4 adenine homopolymer.
...
\item
  On the CHM13 whole human genome assembly v1.1, 50\% of the 3Gb are in homopolymers of size 2 or more, and 10\% are in homopolymers fof size 4 or more. The longest homopolymer in the CHM13 v1.1 whole human genome assembly is 86. Homopolymers of short/medium lengths make up a significant part of the human genome (Figure \ref{fig:HPpercent}).
\item
