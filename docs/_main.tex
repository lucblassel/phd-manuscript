...
\item
  ...
  \item
    ...
    \item
      p24/CA: capsid, core of the viral particle
    \item
      p7/NC: nucleocapsid, protects the genetic information in the viral particle
    \item
  ...
  \item
    ...
    \begin{itemize}
    \item
      SU (surface)/gp 120: responsible for biding to CD4 cells \autocite{bourHumanImmunodeficiencyVirus1995}
    \item
      TM (transmembrane)/gp 41: together with gp120 causes membrane fusion
    \end{itemize}
  \item
    regulatory elements:
    ...
    \begin{itemize}
    \item
      tat (trans-activator of transcription) (!!) activates transcription -\textgreater{} essential promoter
    \item
      rev (Regulator of viron) (!!) helps RNA get out of nucleus (before splicing?) for translation
    \item
      nef (Negative regulatory factor) (accs) prevents host cell from producing defence proteins (CD4)
    \item
      vif (viral infectivity factor) (accs)
    \item
      vpu (viral prot U) (accs) helps during budding (59,61)
    \item
      vpr (viral prot R) (accs)
    \end{itemize}
  \item
    A 10th gene ?
...
\item
  PI: make active site bigger reducing affinity to inhibitors but also to natural substrate \autocite{wensingFifteenYearsHIV2010}
\item
...
\item
  ...
  \item
    Standford HIV Drug resistance database (\url{https://hivdb.stanford.edu/}) with sequences \autocite{rheeHumanImmunodeficiencyVirus2003}
  \end{itemize}
\item
