...
\hypertarget{supervized}{%
\subsection{Supervized}\label{supervized}}
...
\hypertarget{unsupervized}{%
\subsection{Unsupervized}\label{unsupervized}}

\begin{itemize}
\item
  clustering
\item
  dimensionality reduction -\textgreater{} PCA ICA LCA to build features
\end{itemize}
...
\% \textbackslash printbibliography{[}segment=\textbackslash therefsegment,heading=subbibintoc,title=\{References for chapter \textbackslash thechapter\}{]}
