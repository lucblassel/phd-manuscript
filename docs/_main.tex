...
\caption[Homopolymer fraction of the whole human genome by homopolymer length.]{\textbf{Homopolymer fraction of the whole human genome by homopolymer length.}\\The homopolymer counts were calculated from the T2T consortium full human genome assembly CHM13 v1.0. This figure was inspired by Figure 3b of reference \autocite{booeshaghiPseudoalignmentFacilitatesAssignment2022}.}\label{fig:HPpercent}
\end{figure}
