...
Pairwise: reference-based \autocite{martinNextgenerationTranscriptomeAssembly2011,kyriakidouCurrentStrategiesPolyploid2018} and \emph{de novo} \autocite{paszkiewiczNovoAssemblyShort2010,sohnPresentFutureNovo2018} assembly, protein function prediction \autocite{sleatorOverviewSilicoProtein2010}, variant calling \autocite{koboldtBestPracticesVariant2020} and structural variant detection \autocite{alkanGenomeStructuralVariation2011,hoStructuralVariationSequencing2020}, clustering \autocite{sahlinNovoClusteringLongRead2020} MSA: phylogeny \autocite{morrisonPhylogeneticTreebuilding1996,kapliPhylogeneticTreeBuilding2020}, protein structure prediction \autocite{kuhlmanAdvancesProteinStructure2019} etc\ldots{}

More recently focus on machine learning: to predict drug resistance (cf.~Chapter \ref{HIV-paper}), predict protein structure and function, annotate genes, predict protein location, GWAS\ldots{}
...
\hypertarget{mediadeep-learning}{%
\subsection{mediaDeep Learning}\label{mediadeep-learning}}
