...
\begin{itemize}
\item
  illnesses (SNPs, groups of mutations,\ldots)
\item
  acquired traits (drug resistance, \ldots)
\end{itemize}
...
\hypertarget{sanger-sequencing-a-breakthrough-wip}{%
\subsection{Sanger sequencing, a breakthrough (WIP)}\label{sanger-sequencing-a-breakthrough-wip}}
...
\item
  Separate replicated fragments by electrophoresis (i.e shorter fragments go further), 1 ddNTP type in each lane
\item
...
\begin{itemize}
\item
  Massively parallel, Illumina
\item
  Long reads sequencing
\end{itemize}

\textbf{\emph{Quick summary on PacBio and ONT}}
...
Mainly indels, in certain regions of the genomes, particularily homopolymers. For ONT \autocite{delahaye2021,goodwin2015}, for PacBIO and ONT \autocite{dohmBenchmarkingLongreadCorrection2020,weirather2017}, for PacBIO circular consensus \autocite{wenger2019}.
...
\hypertarget{biological-sequences-a-computational-view-here}{%
\section{Biological sequences, a computational view (here ?)}\label{biological-sequences-a-computational-view-here}}
...
Either decide to align globally or locally. Usually done with dynamic programming by assigning a score to mismatches, indels, \ldots{} and then choosing the alignment with minimal score.
...
\begin{table}[H]
\caption{Comparing performance of MSRs on the whole human genome, whole \textit{Drosophila melanogaster} genome, repeated regions of the whole human genome and synthetic centromeric sequence. Results using  \texttt{minimap2}\autocite{liMinimap2PairwiseAlignment2018} and \texttt{winnowmap2}\autocite{jainWeightedMinimizerSampling2020}. The number of simulated reads for each reference sequence is given in parentheses and called $n$. Results are reported for mapq thresholds of 60, 50 and 0. The best performance for each category is highlighted in bold. The percentage difference are computed w.r.t HPC at each given threshold.}
...
mapping friendly sequence reduction & \multicolumn{2}{l}{fraction}                       & \multicolumn{2}{l}{error}                              & \multicolumn{2}{l}{fraction}                       & \multicolumn{2}{l}{error}                              & \multicolumn{2}{l}{fraction}                      & \multicolumn{2}{l}{error}                             \\ \midrule
                                                                                                                                                                                                                                                                                                                                                                            \\
\multicolumn{13}{l}{\textbf{Whole Drosophila melanogaster genome - \texttt{minimap2}(n = \numprint{25764})}}                                                                                                                                                                                                                                                                                  \\
...
MSR$_{\text{E}}$                             & 0.946          & \footnotesize{\;$-$1\%}           & \textbf{0}     & \textbf{\footnotesize{\;$-$100\%}} & 0.954          & \footnotesize{\;$-$1\%}           & \textbf{0}     & \textbf{\footnotesize{\;$-$100\%}} & \textbf{0.998} & \textbf{\footnotesize{\;$+$0\%}} & 1.53e-02          & \footnotesize{\;$+$ 3\%}          \\
...
\begin{figure}[H]
    ...
    \extcaption{Origin of correctly (teal) and incorrectly (red) mapped reads, transformed with MSR$_{\text{E}}$}{Distribution of the origin of correctly and incorrectly mapped simulated reads (in teal and red respectively) on the different chromosomes of the whole human genome. The dark grey rectangle for each chromosome represents the centromere of that chromosome. The lighter gray rectangle on chromosomes 13, 14, 15, 21 and 22 correspond to satellites denoted as ``stalk'', another repetitive region.}
...
\begin{figure}[H]
    ...
    \extcaption{Origin of correctly (teal) and incorrectly (red) mapped reads, transformed with MSR$_{\text{P}}$}{Distribution of the origin of correctly and incorrectly mapped simulated reads (in teal and red respectively) on the different chromosomes of the whole human genome. The dark grey rectangle for each chromosome represents the centromere of that chromosome. The lighter gray rectangle on chromosomes 13, 14, 15, 21 and 22 correspond to satellites denoted as ``stalk'', another repetitive region.}
...
\begin{figure}[H]
    ...
    \extcaption{Origin of correctly (teal) and incorrectly (red) mapped reads, transformed with MSR$_{\text{F}}$}{Distribution of the origin of correctly and incorrectly mapped simulated reads (in teal and red respectively) on the different chromosomes of the whole human genome. The dark grey rectangle for each chromosome represents the centromere of that chromosome. The lighter gray rectangle on chromosomes 13, 14, 15, 21 and 22 correspond to satellites denoted as ``stalk'', another repetitive region.}
