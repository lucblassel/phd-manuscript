...
general context of sequencing errors, i.e.~short reads have high accuracy (After computational correction you can get 10\textsuperscript{-4} to 10\textsuperscript{-5} error rate \autocite{maAnalysisErrorProfiles2019} ) , long reads high error rate

\hypertarget{long-read-errors}{%
\subsection{Long read errors}\label{long-read-errors}}

Mainly indels, in certain regions of the genomes, particularly homopolymers. For ONT \autocite{delahaye2021,goodwin2015}, for PacBIO and ONT \autocite{dohmBenchmarkingLongreadCorrection2020,weirather2017}, for PacBIO circular consensus \autocite{wenger2019}. ONT has more homopolymer errors than PacBIO \autocite{logsdonLongreadHumanGenome2020}.
...
\hypertarget{other-error-correction-methods}{%
\subsubsection{Other error correction methods}\label{other-error-correction-methods}}

\begin{itemize}
\item
  Combining short and long reads, T2T / polishing
\item
  \emph{(Polishing specific to certain sequencing technologies) ?}
\end{itemize}
...
\begin{itemize}
\item
  CCS / HiFi stuff -\textgreater{} 99.8\% accuracy on very long reads (13.5kb) \autocite{wenger2019}
\item
