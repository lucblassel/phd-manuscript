...
\hypertarget{what-type-of-sequencing-errors-happen}{%
\subsection{What type of sequencing errors happen ?}\label{what-type-of-sequencing-errors-happen}}

general context of sequencing errors, i.e.~short reads have high accuracy (After computational correction you can get 10\textsuperscript{-4} to 10\textsuperscript{-5} error rate \autocite{maAnalysisErrorProfiles2019} ) , long reads high error rate as stated before.

Mainly indels, in certain regions of the genomes, particularly homopolymers. For ONT \autocite{delahaye2021,goodwin2015}, for PacBIO and ONT \autocite{dohmBenchmarkingLongreadCorrection2020,weirather2017}. ONT has more homopolymer errors than PacBIO \autocite{logsdonLongreadHumanGenome2020}.
...
\item
  Improving chemistries of ONT pores to R10 supposedly improves homopolymer performance \autocite{R10NewestNanopore,amarasingheOpportunitiesChallengesLongread2020}
\item
...
\hypertarget{biological-sequences-a-computational-view}{%
\section{Biological sequences, a computational view}\label{biological-sequences-a-computational-view}}

Essentially a text file. Just a long succession of letters, so we can apply String/text algorithmics to it.

\emph{Maybe I don't need this to be a separate section but just a conclusion and transition to the next chapter on alignment.}
