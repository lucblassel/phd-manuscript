...
\hypertarget{the-general-supervized-learning-paradigm}{%
\subsection{The general supervized learning paradigm}\label{the-general-supervized-learning-paradigm}}
...
\item
  ...
  \item
    Important that each of these datasets are completely separate -\textgreater{} avoid data leaks.
  \end{itemize}
\item
...
\item
  ...
  \item
    Pretty good predictive power \autocite{zhangOptimalityNaiveBayes}
  \end{itemize}
\item
...
\subsection{Learned embeddings}\label{learned-embeddings}}
...
\item
  ...
  \item
    ...
    \end{itemize}
  \item
    Used to embed sequences from MSAs and find homologies \autocite{caiGenomewidePredictionSmall2020}
  \item
    MSA Transformer
  \end{itemize}
\item
...
Other weirder embeddings: chaos game theory \autocite{lochelChaosGameRepresentation2021}
