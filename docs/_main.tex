...
\begin{itemize}
\item
  Massively parallel, Illumina, \emph{(no need to detail technology, just numbers i.e.~throughput and cost)}
\item
...
general context of sequencing errors, i.e.~short reads have high accuracy, long reads high error rate
...
\subsection{Other Error correction methods}\label{other-error-correction-methods}}
