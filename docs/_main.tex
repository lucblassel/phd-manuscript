...
\fi
\usepackage[style=authoryear,backref=true,refsegment=chapter,defernumbers=true,sorting=none]{biblatex}
...
\hypertarget{biology-basics}{%
\section{Biology basics}\label{biology-basics}}
...
\hypertarget{small-presentationdefinition-of-viruses}{%
\subsection{small presentation/definition of viruses}\label{small-presentationdefinition-of-viruses}}

\hypertarget{dnarna-viruses}{%
\subsection{DNA/RNA viruses}\label{dnarna-viruses}}
...
\hypertarget{sequencing-error-types}{%
\subsection{Sequencing error types}\label{sequencing-error-types}}
...
\hypertarget{short-history-of-sequencing}{%
\subsection{Short history of sequencing}\label{short-history-of-sequencing}}

\hypertarget{long-read-and-ng-technologies}{%
\subsection{Long read and NG technologies}\label{long-read-and-ng-technologies}}
...
\hypertarget{error-mitigating-strategies}{%
\subsection{Error mitigating strategies}\label{error-mitigating-strategies}}
...
\hypertarget{types-of-tasks}{%
\subsection{types of tasks}\label{types-of-tasks}}
...
\(f\) is \emph{RC-insensitive} if for all \(x\), \(f(RC(x))= RC(f(x))\). Observe
