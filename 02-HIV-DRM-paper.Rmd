...
*originally published in PLoS Computational Biology in August 2021*   *[doi:10.1371/journal.pcbi.1008873](https://doi.org/10.1371/journal.pcbi.1008873)*
...
dt <- read_csv("tables/Chapter-02/Table1.csv", )  
...
dt <- read_csv("tables/Chapter-02/Table2.csv", )  
...
grid::grid.raster(
  tiff::readTIFF("./figures/Chapter-02/Fig1.tif")
)
```
...
grid::grid.raster(
  tiff::readTIFF("./figures/Chapter-02/Fig2.tif")
)
```
...
grid::grid.raster(
  tiff::readTIFF("./figures/Chapter-02/Fig3.tif")
)
```
...
grid::grid.raster(
  tiff::readTIFF("./figures/Chapter-02/Fig4.tif")
)
```
