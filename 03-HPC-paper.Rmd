...
# Contribution 1: Improving read alignment by exploring a sequence transformation space
...
it was published in ***DATE HERE***, in the iScience proceedings of the RECOMB-SEQ 2022
conference ([*doi:10.1371/journal.pcbi.1008873*](https://doi.org/10.1371/journal.pcbi.1008873)).  
...
errors [@gusfieldAlgorithmsStringsTrees1997]. Error correction can often decrease the error rate but
...
assemblies [@nurk2022]. These contain many more
...
1.  **Whole human genome:** This reference sequence is a whole genome assembly
    ...
    [@@nurk2022]. We used the 1.1 assembly release (Genbank
    Assembly ID
