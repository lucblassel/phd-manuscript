...
3.  **Synthetic centromeric sequence:** This sequence was obtained from the `TandemTools` mapper test data [@mikheenkoTandemToolsMappingLong2020]. It is a simulated centromeric sequence that is inherently difficult to map reads to. Appendix S1 describes how it was constructed, and it is downloadable from <https://github.com/lucblassel/TandemTools/blob/master/test_data/simulated_del.fasta>
