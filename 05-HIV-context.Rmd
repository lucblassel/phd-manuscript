...
-   INSTI resistance: reduce affinity to inhibitors [@blancoHIV1IntegraseInhibitor2011]
...
-   PI resistance: make active site bigger reducing affinity to inhibitors but also to natural substrate [@wensingFifteenYearsHIV2010], also change flap conformation to deny access to active site to PI [@kurtyilmazImprovingViralProtease2016].
