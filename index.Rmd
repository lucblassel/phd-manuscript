...
biblatexoptions: [backref=true, refsegment=chapter, defernumbers=true, sorting=none, uniquelist=false, style=numeric-comp, maxcitenames=2, maxnames = 5, firstinits=true, uniquename=init, url=false, isbn=false, eprint=false, texencoding=utf8, bibencoding=utf8, autocite=superscript, backend=biber]
link-citations: yes
