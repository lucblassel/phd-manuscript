...
### Sanger sequencing, a breakthrough (WIP)
...
-   Massively parallel, Illumina, *(no need to detail technology, just numbers i.e. throughput and cost)*
...
Mainly indels, in certain regions of the genomes, particularily homopolymers. For ONT [@delahaye2021; @goodwin2015], for PacBIO and ONT [@dohmBenchmarkingLongreadCorrection2020; @weirather2017], for PacBIO circular consensus [@wenger2019]. ONT has more homopolymer errors than PacBIO [@logsdonLongreadHumanGenome2020].
