...
### What type of sequencing errors happen ?

general context of sequencing errors, i.e. short reads have high accuracy (After computational correction you can get 10^-4^ to 10^-5^ error rate [@maAnalysisErrorProfiles2019] ) , long reads high error rate as stated before.

Mainly indels, in certain regions of the genomes, particularly homopolymers. For ONT [@delahaye2021; @goodwin2015], for PacBIO and ONT [@dohmBenchmarkingLongreadCorrection2020; @weirather2017]. ONT has more homopolymer errors than PacBIO [@logsdonLongreadHumanGenome2020].
...
-   Improving chemistries of ONT pores to R10 supposedly improves homopolymer performance [@R10NewestNanopore; @amarasingheOpportunitiesChallengesLongread2020]
...
-   Used in many software tools for long reads [@auImprovingPacBioLong2012; @nurkHiCanuAccurateAssembly2020; @liMinimap2PairwiseAlignment2018; @ruanFastAccurateLongread2020; @shafinNanoporeSequencingShasta2020; @sahlin2020novo; @ekimMinimizerspaceBruijnGraphs2021] and even pyrosequencing reads [@miller2008aggressive]
