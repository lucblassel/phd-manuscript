...
```{r, big-hp-distrib, fig.cap="Distribution of homopolymer lengths per base in the human genome"}
ggplot(big, aes(x=length, y=count, fill=base)) +
  geom_col() +
  facet_wrap(. ~ base)
```

```{r, hp-freq, fig.cap="Homopolymer length as fraction of the genome"}
#labels = c("", "", "", "", "", "", "", "", "", "10^1", "", "", "", "", "", "", "", "", "10^2"),
