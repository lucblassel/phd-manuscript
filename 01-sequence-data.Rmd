...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\linewidth]{./figures/Sequence-Intro/Frameshift.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\linewidth]{./figures/Sequence-Intro/Hpc.png}
